...
public class MainActivity extends AppCompatActivity
    ...
    String[] listArray={"Official Website Akakom","Portal Akademik","PMB Akakom","Blog Mahasiswa","Laboratorium Akakom",};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter adapter = new ArrayAdapter(this,R.layout.activity_tautan,listArray);
